...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-7 flex items-center justify-between">
      <div className="logo">
        <h1 className="text-3xl font-extrabold tracking-wide bg-linear-to-r from-violet-400 to-pink-400 text-transparent bg-clip-text">
          Portfolio
        </h1>
      </div>
      <ul
        className={`menu flex items-center sm:gap-10 gap-4 md:static fixed left-1/2 -translate-x-1/2 md:translate-x-0 md:opacity-100 bg-white/30 backdrop-blur-md p-4 rounded-br-2xl rounded-bl-2xl md:bg-transparent transition-all md:transition-none z-40 ${
          active ? "md:top-0 md:opacity-100" : "md:-top-10 md:opacity-0"
        }`}
      >
        <li>
        ...
        <li>
          <a href="#sertifikat" className="sm:text-lg text-base font-medium">
            Sertifikat
          </a>
        </li>
        <li>
